              ...
              <form id="penilaian_pg">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control total" id="volume" name = "volume">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group d-none" id ="tslain">
                    <label for="slain">Satuan Lainnya</label>
                    <input type="text" class="form-control" id="slain" name = "slain">
                  </div>
                  <div class="form-group">
                    <label for="hsatuan">Harga Satuan</label>
                    <input type="text" class="form-control total" id="hsatuan" name = "hsatuan"/>
                  </div>
                  <div class="form-group">
                    <label for="honor">Total Honor</label>
...
<script>
  $(function () {
    var thonor = function(){
      ...
      var num1 = $('#volume').val();
      var num2 = $('#hsatuan').val().replace(/\./g, '');;
...
$(function(){
  $('#satuan').on('change',function() {
    var satuan = $(this).val();
          if (satuan == "Lainnya"){
            $( "#tslain" ).removeClass( "d-none" );
          } else {
            if ($( "#tslain" ).hasClass( "d-none" ) == false){
              $( "#tslain" ).addClass( "d-none" );
            }
          }
  });
})
